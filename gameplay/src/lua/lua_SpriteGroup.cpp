...
void luaRegister_SpriteGroup()
{
    const luaL_Reg lua_members[] = 
    {
        ...
        {"setGap", lua_SpriteGroup_setGap},
        {"setHeight", lua_SpriteGroup_setHeight},
        ...
        {"setWidth", lua_SpriteGroup_setWidth},
        {NULL, NULL}
    };
    const luaL_Reg lua_statics[] = 
    {
        ...
        {"ANIMATE_GAP", lua_SpriteGroup_static_ANIMATE_GAP},
        {"ANIMATE_GAP_HORZ", lua_SpriteGroup_static_ANIMATE_GAP_HORZ},
        {"ANIMATE_GAP_VERT", lua_SpriteGroup_static_ANIMATE_GAP_VERT},
        {"ANIMATE_OFFSET", lua_SpriteGroup_static_ANIMATE_OFFSET},
        {"ANIMATE_OFFSET_X", lua_SpriteGroup_static_ANIMATE_OFFSET_X},
        {"ANIMATE_OFFSET_Y", lua_SpriteGroup_static_ANIMATE_OFFSET_Y},
        {"ANIMATE_SIZE", lua_SpriteGroup_static_ANIMATE_SIZE},
        {"ANIMATE_SIZE_HEIGHT", lua_SpriteGroup_static_ANIMATE_SIZE_HEIGHT},
        {"ANIMATE_SIZE_WIDTH", lua_SpriteGroup_static_ANIMATE_SIZE_WIDTH},
...
int lua_SpriteGroup_getGap(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            {
                SpriteGroup* instance = getInstance(state);
                void* returnPtr = (void*)new Vector2(instance->getGap());
                if (returnPtr)
                {
                    gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                    object->instance = returnPtr;
            ...
            lua_pushstring(state, "lua_SpriteGroup_getGap - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TNIL))
                {
                    ...
                    SpriteGroup* instance = getInstance(state);
                    instance->setGap(*param1);
                    
                    return 0;
                }
            } while (0);

            lua_pushstring(state, "lua_SpriteGroup_setGap - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_SpriteGroup_setHeight(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_SpriteGroup_setHeight - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_SpriteGroup_setWidth(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_SpriteGroup_setWidth - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_SpriteGroup_static_ANIMATE_GAP(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_GAP;
...
int lua_SpriteGroup_static_ANIMATE_GAP_HORZ(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_GAP_HORZ;
...
int lua_SpriteGroup_static_ANIMATE_GAP_VERT(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_GAP_VERT;
...
int lua_SpriteGroup_static_ANIMATE_OFFSET_X(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_OFFSET_X;
...
int lua_SpriteGroup_static_ANIMATE_OFFSET_Y(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_OFFSET_Y;
...
int lua_SpriteGroup_static_ANIMATE_SIZE_HEIGHT(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_SIZE_HEIGHT;
...
int lua_SpriteGroup_static_ANIMATE_SIZE_WIDTH(lua_State* state)
{
    ...
    int result = SpriteGroup::ANIMATE_SIZE_WIDTH;
...
int lua_SpriteGroup_static_create(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TSTRING || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    void* returnPtr = (void*)SpriteGroup::create(param1);
                    if (returnPtr)
                    {
                        gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                        object->instance = returnPtr;
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    ...
                    void* returnPtr = (void*)SpriteGroup::Sprite::create(param1, param2);
                    if (returnPtr)
                    {
                        gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                        object->instance = returnPtr;
        ...
        default:
        {
            lua_pushstring(state, "Invalid number of parameters (expected 1, 2 or 4).");
            lua_error(state);
            break;
        }
    }

...
void luaRegister_Sprite()
{
    const luaL_Reg lua_members[] = 
    {
        ...
        {"getOffsetX", lua_Sprite_getOffsetX},
        {"getOffsetY", lua_Sprite_getOffsetY},
        ...
        {"setHeight", lua_Sprite_setHeight},
    ...
    const luaL_Reg lua_statics[] = 
    {
        ...
        {"ANIMATE_OFFSET_X", lua_Sprite_static_ANIMATE_OFFSET_X},
        {"ANIMATE_OFFSET_Y", lua_Sprite_static_ANIMATE_OFFSET_Y},
        {"ANIMATE_SIZE", lua_Sprite_static_ANIMATE_SIZE},
        {"ANIMATE_SIZE_HEIGHT", lua_Sprite_static_ANIMATE_SIZE_HEIGHT},
        {"ANIMATE_SIZE_WIDTH", lua_Sprite_static_ANIMATE_SIZE_WIDTH},
        ...
        {"getDefaultSpriteOffset", lua_Sprite_static_getDefaultSpriteOffset},
        {"setDefaultSpriteOffset", lua_Sprite_static_setDefaultSpriteOffset},
        {NULL, NULL}
    };
...
int lua_Sprite_getOffsetX(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_Sprite_getOffsetX - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_getOffsetY(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_Sprite_getOffsetY - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_getSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_Sprite_getSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_setHeight(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Sprite_setHeight - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_setOffsetX(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Sprite_setOffsetX - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_setOffsetY(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Sprite_setOffsetY - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_setSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Sprite_setSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_Sprite_setWidth(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Sprite_setWidth - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Sprite_static_ANIMATE_FRAME_INDEX(lua_State* state)
{
    ...
    int result = Sprite::ANIMATE_FRAME_INDEX;
...
int lua_Sprite_static_ANIMATE_FRAME_SPECIFIC(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
...
int lua_Sprite_static_ANIMATE_OFFSET(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_OFFSET;
...
int lua_Sprite_static_ANIMATE_OFFSET_X(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_OFFSET_X;
...
int lua_Sprite_static_ANIMATE_OFFSET_Y(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_OFFSET_Y;
...
int lua_Sprite_static_ANIMATE_SIZE(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_SIZE;
...
int lua_Sprite_static_ANIMATE_SIZE_HEIGHT(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_SIZE_HEIGHT;
...
int lua_Sprite_static_ANIMATE_SIZE_WIDTH(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_SIZE_WIDTH;
...
int lua_Sprite_static_ANIMATE_TINT(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = Sprite::ANIMATE_TINT;
...
int lua_Sprite_static_getDefaultSpriteOffset(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 0:
        {
            void* returnPtr = (void*)&(Sprite::getDefaultSpriteOffset());
            if (returnPtr)
            {
                gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                object->instance = returnPtr;
    ...
    switch (paramCount)
    {
        case 1:
        {
            if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
            {
                ...
                Sprite::setDefaultSpriteOffset(*param1);
                
                return 0;
            }

            lua_pushstring(state, "lua_Sprite_static_setDefaultSpriteOffset - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:

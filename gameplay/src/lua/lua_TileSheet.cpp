...
void luaRegister_TileSheet()
{
    ...
    const luaL_Reg lua_statics[] = 
    {
        ...
        {"getTileSheet", lua_TileSheet_static_getTileSheet},
        {NULL, NULL}
    };
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TNUMBER)
            {
                ...
                TileSheet* instance = getInstance(state);
                void* returnPtr = (void*)&(instance->getStripFrameById(param1, param2));
                if (returnPtr)
                {
                    gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                    object->instance = returnPtr;
            ...
            lua_pushstring(state, "lua_TileSheet_getStripFrameById - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
    ...
    switch (paramCount)
    {
        case 5:
        {
                ...
                lua_type(state, 5) == LUA_TNUMBER)
            {
                ...
                TileSheet* instance = getInstance(state);
                instance->getStripFramesById(param1, param2, param3, param4);
                
                return 0;
            }

            lua_pushstring(state, "lua_TileSheet_getStripFramesById - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TSTRING || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                TileSheet* instance = getInstance(state);
                int result = instance->getStripIndex(param1);
            ...
            lua_pushstring(state, "lua_TileSheet_getStripIndex - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
    ...
    switch (paramCount)
    {
        case 4:
        {
                ...
                (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TNIL))
            {
                ...
                TileSheet* instance = getInstance(state);
                instance->setStripFrameById(param1, param2, *param3);
                
                return 0;
            }

            lua_pushstring(state, "lua_TileSheet_setStripFrameById - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
    ...
    switch (paramCount)
    {
        case 5:
        {
                ...
                lua_type(state, 5) == LUA_TNUMBER)
            {
                ...
                TileSheet* instance = getInstance(state);
                instance->setStripFramesById(param1, param2, param3, param4);
                
                return 0;
            }

            lua_pushstring(state, "lua_TileSheet_setStripFramesById - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TSTRING || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    void* returnPtr = (void*)TileSheet::create(param1);
                    if (returnPtr)
                    {
                        gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                        object->instance = returnPtr;
    ...
    switch (paramCount)
    {
        case 1:
        {
            if ((lua_type(state, 1) == LUA_TSTRING || lua_type(state, 1) == LUA_TNIL))
            {
                ...
                void* returnPtr = (void*)TileSheet::getTileSheet(param1);
                if (returnPtr)
                {
                    gameplay::ScriptUtil::LuaObject* object = (gameplay::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(gameplay::ScriptUtil::LuaObject));
                    object->instance = returnPtr;
            ...
            lua_pushstring(state, "lua_TileSheet_static_getTileSheet - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
